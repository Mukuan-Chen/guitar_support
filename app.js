...
const chordTypes = [
  { label: "Major", suffix: "", intervals: [0, 4, 7], formula: ["1", "3", "5"], required: [0, 4, 7] },
  { label: "Minor", suffix: "m", intervals: [0, 3, 7], formula: ["1", "b3", "5"], required: [0, 3, 7] },
  { label: "7", suffix: "7", intervals: [0, 4, 7, 10], formula: ["1", "3", "5", "b7"], required: [0, 4, 10] },
  { label: "5", suffix: "5", intervals: [0, 7], formula: ["1", "5"], required: [0, 7], minPlayed: 2 },
  { label: "dim", suffix: "dim", intervals: [0, 3, 6], formula: ["1", "b3", "b5"], required: [0, 3, 6] },
  { label: "dim7", suffix: "dim7", intervals: [0, 3, 6, 9], formula: ["1", "b3", "b5", "bb7"], required: [0, 3, 6, 9] },
  { label: "aug", suffix: "aug", intervals: [0, 4, 8], formula: ["1", "3", "#5"], required: [0, 4, 8] },
  { label: "sus2", suffix: "sus2", intervals: [0, 2, 7], formula: ["1", "2", "5"], required: [0, 2, 7] },
  { label: "sus4", suffix: "sus4", intervals: [0, 5, 7], formula: ["1", "4", "5"], required: [0, 5, 7] },
  { label: "maj7", suffix: "maj7", intervals: [0, 4, 7, 11], formula: ["1", "3", "5", "7"], required: [0, 4, 11] },
  { label: "m7", suffix: "m7", intervals: [0, 3, 7, 10], formula: ["1", "b3", "5", "b7"], required: [0, 3, 10] },
  { label: "7sus4", suffix: "7sus4", intervals: [0, 5, 7, 10], formula: ["1", "4", "5", "b7"], required: [0, 5, 10] }
];
